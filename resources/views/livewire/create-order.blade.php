    ...
    <div class="col-span-3">
        <div class="bg-white rounded-lg shadow p-6">
            <div class="mb-4">
                ...
                <x-jet-input dusk="contact" type="text"
            ...
            <div>
                ...
                <x-jet-input dusk="phone" type="text"
        ...
        <div x-data="{ envio_type: @entangle('envio_type') }">
            ...
            <label class="bg-white rounded-lg shadow px-6 py-4 flex items-center mb-4">
                <input dusk="puntoDeRecogida" x-model="envio_type" type="radio" name="envio_type" value="1" class="text-gray-600">
            ...
            <div class="bg-white rounded-lg shadow">
                ...
                <div class="px-6 pb-6 grid grid-cols-2 gap-6" :class="{ 'hidden': envio_type != 2 }">
                    <div>
                        ...
                        <select id="departamento" class="form-control w-full" wire:model="department_id">
                    ...
                    <div>
                        ...
                        <select id="ciudad" class="form-control w-full" wire:model="city_id">
                    ...
                    <div>
                        ...
                        <select id="distrito" class="form-control w-full" wire:model="district_id">
